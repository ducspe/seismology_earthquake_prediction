...
if __name__ == "__main__":
    ...
    wgrn04_base_path = "../../cloudcontainer/Parameters_downloaded_on_jan5/wgrn04/alt"

    # List all file names in alt directory:
    all_files_list = os.listdir(wgrn04_base_path)
    print("All files: ", all_files_list)

    for found_file in all_files_list:
        file_path = f"{wgrn04_base_path}/{found_file}"
    ...
    df_final.to_hdf("../../cloudcontainer/wgrn04_features.hdf5", key='wgrn04', mode='w')